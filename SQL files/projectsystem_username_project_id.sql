...
--
-- Table structure for table `username_project_id`
--

DROP TABLE IF EXISTS `username_project_id`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8 */;
CREATE TABLE `username_project_id` (
...
--
-- Dumping data for table `username_project_id`
--
